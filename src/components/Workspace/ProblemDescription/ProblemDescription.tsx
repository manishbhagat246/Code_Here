	...
	return (
		...
		<div className='bg-dark-layer-1 rounded-t-[5px] px-5 py-[10px] text-xs cursor-pointer ml-2'>
		{!user && (
							<div className='cursor-pointer group relative'>
							Sign in to see your solution                     
							
					</div>
					)}
								{user && currentProblem && (
									<Link href={`/mysolution?id=${currentProblem.id}`} className='cursor-pointer group relative'>
										Your Solution
									</Link>
									)}
		...
		<div className='flex px-0 py-4 h-[calc(100vh-94px)] overflow-y-auto'>
			...
			<div className='text-white text-sa'>
