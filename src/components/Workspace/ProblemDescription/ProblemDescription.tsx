        ...
        <div className='px-5'>
          ...
          <div className='w-full'>
            ...
            <div className='flex items-center mt-3'>
              <div className='bg-dark-green-s text-dark-green-s inline-block rounded-[21px] bg-opacity-[.15] px-2.5 py-1 text-xs font-medium capitalize'>
                Easy
              </div>
          ...
          <div>
            ...
            <div className='example-card'>
              <pre>
                <strong className='text-white'>Input: </strong> nums [2,7,11,15],
                target = 9{" "}
                <br />
